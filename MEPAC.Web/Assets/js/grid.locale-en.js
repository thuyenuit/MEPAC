...
(function (a) {
    ...
    a.jgrid.regional.en = {
        defaults: {
            recordtext: "Hiển thị <strong> {0} </strong> - <strong> {1} </strong> của <strong> {2} </strong> bản ghi",
        ...
        formatter: {
            ...
            currency: {
                decimalSeparator: ".",
                thousandsSeparator: ",",
                decimalPlaces: 2, prefix: "", suffix: "", defaultValue: "0.00"},
            date: {
                //dayNames: [
