...
(function (app) {
    app.controller('projectsListController', projectsListController);

    projectsListController.$inject = ['$scope',
        'apiService', '$interval', '$filter', '$ngBootbox', '$state', 'notificationService'];

    function projectsListController($scope, apiService, $interval,
